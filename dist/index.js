...
"use strict";
Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=__webpack_require__(3);var _react2=_interopRequireDefault(_react);var _propTypes=__webpack_require__(2);var _propTypes2=_interopRequireDefault(_propTypes);var _polaris=__webpack_require__(5);var _idGenerator=__webpack_require__(26);var _lodash=__webpack_require__(28);var _=_interopRequireWildcard(_lodash);var _styles=__webpack_require__(18);var styles=_interopRequireWildcard(_styles);function _interopRequireWildcard(obj){if(obj&&obj.__esModule){return obj;}else{var newObj={};if(obj!=null){for(var key in obj){if(Object.prototype.hasOwnProperty.call(obj,key))newObj[key]=obj[key];}}newObj.default=obj;return newObj;}}function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}var idGenerator=(0,_idGenerator.createUniqueIDFactory)('table');var tableId=idGenerator();var FfDataTable=function(_React$PureComponent){_inherits(FfDataTable,_React$PureComponent);function FfDataTable(props){_classCallCheck(this,FfDataTable);var _this=_possibleConstructorReturn(this,(FfDataTable.__proto__||Object.getPrototypeOf(FfDataTable)).call(this,props));_this.renderRows=function(rowData,rowIndex){var _this$props=_this.props,trackSelectionBy=_this$props.trackSelectionBy,selectedRows=_this$props.selectedRows,columns=_this$props.columns;var formattedRow=[];var isSelected=_.find(selectedRows,function(rowId){return rowData[trackSelectionBy]===rowId||rowIndex===rowId;});formattedRow.push(_react2.default.createElement(_polaris.Checkbox,{checked:isSelected,onChange:function onChange(){return _this.onSelectRow(rowData[trackSelectionBy]||rowIndex);}}));_.forEach(columns,function(column){if(column===trackSelectionBy){return;}else{formattedRow.push(_react2.default.createElement('div',{className:styles.cellElement,key:column.key,onClick:function onClick(){return _this.props.onRowClick(rowData);}},rowData[column.key]));}});return formattedRow;};_this.onColumnSort=function(index,direction){var columns=_this.props.columns;// index - 1 is done to ignore the header checkbox
var column=columns[index-1].key;_this.props.onSortChange(column,direction);};_this.onSelectRow=function(rowId){var selectedRows=_this.props.selectedRows;var newlySelectedRows;if(rowId==='all'){newlySelectedRows=rowId;}else{// xor will toggle the rowId in selected row array
newlySelectedRows=_.xor(selectedRows,[rowId]);}_this.props.onSelectionChange(newlySelectedRows);};return _this;}_createClass(FfDataTable,[{key:'componentDidMount',value:function componentDidMount(){var _this2=this;setTimeout(function(){_this2.configureObserver();},0);}},{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps){if(!_.isEqual(this.props.rows.length,nextProps.rows&&nextProps.rows.length)){this.configureObserver();}}},{key:'configureObserver',value:function configureObserver(){var _props=this.props,loadMoreRecords=_props.loadMoreRecords,observerRowIndex=_props.observerRowIndex;if(!loadMoreRecords){return;}var table=document.getElementById(tableId);var rows=table.getElementsByTagName('tr')||[];if(!rows[rows.length-observerRowIndex]){return;}if('IntersectionObserver'in window){var onChange=function onChange(changes,observer){_.forEach(changes,function(change){if(change.intersectionRatio>0){loadMoreRecords();observer.unobserve(change.target);}});};// IntersectionObserver Supported
...
loadMoreRecords();}}},{key:'render',value:function render(){var _this3=this;var _props2=this.props,rows=_props2.rows,columns=_props2.columns,sortBy=_props2.sortBy,selectAllStatus=_props2.selectAllStatus;// Prepare props for polaris table
var columnContentTypes=[],columnHeadings=[],columnSortable=[],formattedRows=[];var sortedColumnIndex=_.findIndex(columns,function(col){return col.key===sortBy.field;});var sortDirection=sortBy.order;columnContentTypes.push('string');columnSortable.push(false);columnHeadings.push(_react2.default.createElement(_polaris.Checkbox,{checked:selectAllStatus,onChange:function onChange(){return _this3.onSelectRow('all');}}));_.each(columns,function(column){columnContentTypes.push(column.type);columnHeadings.push(column.displayName);columnSortable.push(column.sortable);});_.forEach(rows,function(row,index){formattedRows.push(_this3.renderRows(row,index));});return _react2.default.createElement(_polaris.AppProvider,null,_react2.default.createElement(_polaris.Card,null,_react2.default.createElement('div',{id:tableId},_react2.default.createElement(_polaris.DataTable,{columnContentTypes:columnContentTypes,headings:columnHeadings,sortable:columnSortable,rows:formattedRows,onSort:this.onColumnSort,defaultSortDirection:sortDirection,initialSortColumnIndex:sortedColumnIndex}),!rows.length?_react2.default.createElement('div',{className:styles.noRecords},'No Records found'):null)));}}]);return FfDataTable;}(_react2.default.PureComponent);FfDataTable.defaultProps={trackSelectionBy:'id',observerRowIndex:10};FfDataTable.propTypes={columns:_propTypes2.default.arrayOf(_propTypes2.default.shape({displayName:_propTypes2.default.string,key:_propTypes2.default.string,sortable:_propTypes2.default.bool,type:_propTypes2.default.string})),onSortChange:_propTypes2.default.func,rows:_propTypes2.default.arrayOf(_propTypes2.default.object),selectedRows:_propTypes2.default.arrayOf(_propTypes2.default.oneOfType([_propTypes2.default.number,_propTypes2.default.string])),onSelectionChange:_propTypes2.default.func,onRowClick:_propTypes2.default.func,/**
   * variable which will handle the row selection
   * usualy it will be the unique id
   */trackSelectionBy:_propTypes2.default.string,sortBy:_propTypes2.default.shape({field:_propTypes2.default.string,order:_propTypes2.default.oneOf(['ascending','descending'])}),selectAllStatus:_propTypes2.default.oneOfType([_propTypes2.default.string,_propTypes2.default.bool]),/**
   ...
   */loadMoreRecords:_propTypes2.default.func};exports.default=FfDataTable;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["createUniqueIDFactory"] = createUniqueIDFactory;
